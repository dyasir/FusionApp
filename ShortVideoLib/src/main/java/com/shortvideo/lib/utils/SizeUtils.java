...
public final class SizeUtils {
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = VideoApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static float applyDimension(final float value, final int unit) {
        DisplayMetrics metrics = VideoApplication.getInstance().getResources().getDisplayMetrics();
        switch (unit) {
