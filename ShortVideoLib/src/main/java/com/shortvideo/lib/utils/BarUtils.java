...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (VideoApplication.getInstance().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, VideoApplication.getInstance().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = VideoApplication.getInstance().getSystemService("statusbar");
