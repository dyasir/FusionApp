...
import com.shortvideo.lib.ui.activity.concise.view.IMGColorGroup;
import com.shortvideo.lib.ui.activity.concise.view.IMGView;
...
abstract class IMGEditBaseActivity extends Activity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bitmap != null) {
            setContentView(R.layout.tk_image_edit_activity);
            initViews();
