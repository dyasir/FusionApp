package com.shortvideo.lib.ui.activity.concise.gallery;
...
import com.shortvideo.lib.ui.activity.concise.widget.IMGViewHolderCallback;
...
public class IMGGalleryMenuWindow extends PopupWindow {
    ...
    public IMGGalleryMenuWindow(Context context) {
        ...
        View contentView = getLayoutInflater().inflate(
                R.layout.tk_image_layout_gallery_pop, null, false);
    ...
    private class MenuAdapter extends RecyclerView.Adapter<MenuItemViewHolder>
        ...
        public MenuItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MenuItemViewHolder(getLayoutInflater().inflate(
                    R.layout.tk_image_layout_gallery_menu_item, parent, false), this);
        }
