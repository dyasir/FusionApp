...
import com.shortvideo.lib.ui.activity.concise.core.util.IMGPermissionUtils;
import com.shortvideo.lib.ui.activity.concise.gallery.IMGGalleryMenuWindow;
import com.shortvideo.lib.ui.activity.concise.gallery.IMGScanTask;
import com.shortvideo.lib.ui.activity.concise.gallery.IMGScanner;
import com.shortvideo.lib.ui.activity.concise.gallery.model.IMGChooseMode;
import com.shortvideo.lib.ui.activity.concise.gallery.model.IMGImageInfo;
import com.shortvideo.lib.ui.activity.concise.gallery.model.IMGImageViewModel;
import com.shortvideo.lib.ui.activity.concise.widget.IMGGalleryHolderCallback;
...
public class IMGGalleryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tk_image_gallery_activity);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.tk_image_menu_gallery, menu);
    ...
    private void onDone() {
        ...
        if (infos.size() > 0) {
            File mImageFile = new File(TkAppConfig.MY_PHOTO_PATH + UUID.randomUUID().toString() + ".jpg");
            Intent intent = new Intent(this, IMGEditActivity.class);
            intent.putExtra(IMGEditActivity.EXTRA_IMAGE_URI, infos.get(0).getUri());
    ...
    private class ImageAdapter extends RecyclerView.Adapter<ImageViewHolder>
        ...
        public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ImageViewHolder(getLayoutInflater().inflate(
                    R.layout.tk_image_layout_image, parent, false), this);
        }
